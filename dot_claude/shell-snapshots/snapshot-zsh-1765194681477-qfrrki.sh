...
if ! command -v rg >/dev/null 2>&1; then
  alias rg=''\''/Users/kbrdn1/Library/Application Support/Zed/external_agents/claude-code-acp/0.11.0/node_modules/@anthropic-ai/claude-agent-sdk/vendor/ripgrep/arm64-darwin/rg'\'''
fi
