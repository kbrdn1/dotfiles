...
**Always use the Claude Dark palette.** Copy this block into every generated page. See `./claude-dark-palette.md` for the full reference.
...
:root {
  ...
  /* Semantic aliases for diagram elements */
  --node-a: #D4825D;
  --node-a-dim: rgba(212, 130, 93, 0.15);
  --node-b: #86E89A;
  --node-b-dim: rgba(134, 232, 154, 0.12);
  --node-c: #7AB8FF;
  --node-c-dim: rgba(122, 184, 255, 0.12);
}
...
@media (prefers-color-scheme: light) {
  :root {
    ...
    --node-a: #C15F3C;
    --node-a-dim: rgba(193, 95, 60, 0.12);
    --node-b: #86E89A;
    --node-b-dim: rgba(134, 232, 154, 0.18);
    --node-c: #7AB8FF;
    --node-c-dim: rgba(122, 184, 255, 0.18);
  }
}
```
