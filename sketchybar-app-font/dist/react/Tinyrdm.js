...
export const Tinyrdm = props => (
  <svg viewBox="0 0 20 20"  {...props} className={`sketchybar-app-font ${props.className ? props.className : ''}`}><path d="M295 581 c-41 -12 -184 -101 -199 -123 -12 -17 -16 -49 -16 -134 0
...
-38 42 -25 88 -47 103 -50z" fillRule="evenodd" /></svg>
);
