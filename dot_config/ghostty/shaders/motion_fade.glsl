// Shader motion sobre - traînée qui s'estompe progressivement
...
// Couleur sobre (bleu clair/gris)
const vec4 TRAIL_COLOR = vec4(0.5, 0.7, 0.9, 1.0);
const float DURATION = 0.4; // Durée de la traînée en secondes
...
void mainImage(out vec4 fragColor, in vec2 fragCoord)
{
    ...
    // Facteur de fade basé sur la distance
